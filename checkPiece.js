...
// piece判定
// ======================
export function checkPiece(piece, playerPiece) {
	// player側
	const normalizedPlayer = normalizeCoords(JSON.parse(JSON.stringify(playerPiece)));
	// pieceの全パターン取得
	...
	for (const pattern of piecePatterns) {
		...
		// 一致判定
		if (JSON.stringify(normalizedPlayer) === JSON.stringify(normalizedPattern)) {
